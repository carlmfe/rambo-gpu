...
// =============================================================================
// Get SYCL device info helper
// =============================================================================
std::string getDeviceName(sycl::queue& queue) {
...
int main(int argc, char* argv[]) {
    ...
    // Create SYCL queue with GPU selector to get device info
    sycl::queue queue{sycl::gpu_selector_v};
    const std::string deviceName = getDeviceName(queue);
    
    std::cout << "======================================" << std::endl;
    std::cout << "RAMBO Monte Carlo Integrator (SYCL)" << std::endl;
    std::cout << "======================================" << std::endl;
    std::cout << "Compiled backend: SYCL (CUDA)" << std::endl;
    ...
    // Run benchmark using Diet phase-space (better two-body handling)
