...
#include "rambo_alpaka.hpp"

// =============================================================================
// Concepts
// =============================================================================

// C++20 concept for integrands: must have evaluate() method taking momenta array
template <typename T>
...
// Monte Carlo integration kernel using RAMBO phase space sampling
// Each thread generates one event, computes the integrand, and contributes to the sum
...
// Integrand-agnostic Monte Carlo integrator using Alpaka
...
public:
    ...
    void run(double energy, const double* hostMasses,
        ...
        // Copy results and compute statistics
